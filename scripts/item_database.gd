...
const ITEMS = {
	...
	"wpn_laser": {
		...
		"stats": {"damage": 15, "fire_rate": 0.10, "range": 700}
	},
	"wpn_plasma": {
		...
		"stats": {"damage": 25, "fire_rate": 0.20, "range": 800}
	},
